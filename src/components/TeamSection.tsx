        ...
        <div className="container relative z-10">
              ...
              >
                {shariahBoard.map((member) => (
                  ...
                  >
                    ...
                    <div className="relative w-44 h-44 sm:w-52 sm:h-52 md:w-48 md:h-48 lg:w-60 lg:h-60 flex-shrink-0 overflow-hidden bg-gradient-to-br from-secondary/20 to-secondary/5 m-3 border-2 border-primary rounded-xl">
                      {member.avatar_url ? (
                        <OptimizedImage 
          ...
          >
            {managementTeam.map((member) => (
              ...
              >
                {/* Square Image Container with inner border */}
                <div className="relative aspect-square w-full overflow-hidden bg-gradient-to-br from-primary/20 to-primary/5 m-3 border-2 border-primary rounded-xl">
                  {member.avatar_url ? (
                    <OptimizedImage 
                      src={member.avatar_url} 
                      alt={member.name}
